import sys
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QGridLayout, QRadioButton, QButtonGroup, QComboBox, QCheckBox
...
class Ventana(QWidget):
    def __init__(self):
        ...
        # EJERCICIO 5: Checkbox de términos y condiciones
        checkbox_terminos = QCheckBox("Acepto los términos y condiciones")
        layout.addWidget(checkbox_terminos, 6, 0, 1, 3)  # Fila 6, ocupa 3 columnas
