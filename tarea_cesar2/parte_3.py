...
class Ventana(QWidget):
    def __init__(self):
        ...
        # EJERCICIO 3: Label para Género
        label_genero = QLabel("Género:")
        layout.addWidget(label_genero, 4, 0)  # Fila 4, columna 0

        # EJERCICIO 3: RadioButtons para Masculino y Femenino en la misma fila
        ...
        # EJERCICIO 3: Agrupar los RadioButtons para que solo uno pueda estar seleccionado
